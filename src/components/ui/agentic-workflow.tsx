    ...
    return (
        <section className="bg-black py-16 lg:py-24 px-6 relative overflow-hidden flex items-center justify-center min-h-[400px]">
             ...
             <div className="relative z-10 w-full max-w-2xl mx-auto">
                 ...
                 >
                     <PixelBackground 
                         className="w-full h-full p-6 md:p-10 rounded-xl"
                     ...
                     >
                         <div className="flex flex-col items-center justify-center text-center">
                             ...
                             <div className="inline-block bg-[#d97757]/90 px-4 py-1.5 rounded-full border border-[#d97757] mb-5 md:mb-8 shadow-[0_0_15px_rgba(217,119,87,0.3)] transform rotate-1">
                             ...
                             <p className="text-gray-400 font-mono text-sm md:text-base max-w-2xl mx-auto leading-relaxed mb-0 drop-shadow-md">
                                 {t.agentic.desc}
                             </p>
                         </div>
                     </PixelBackground>
