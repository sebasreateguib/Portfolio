                    ...
                    >
                        ...
                        <div className="flex flex-col gap-8 lg:gap-10">
                            ...
                            <div className="order-1 lg:order-2 grid w-[min(100%,19rem)] grid-cols-2 gap-2 lg:flex lg:w-auto lg:max-w-none lg:flex-row lg:flex-wrap lg:gap-4">
                                ...
                                <a href="https://github.com/sebasreateguib" target="_blank" rel="noopener noreferrer" className="relative flex min-h-11 items-center justify-center gap-2 px-3 py-2 lg:px-6 lg:py-2.5 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200">
                                ...
                                <a href="https://www.linkedin.com/in/sebasreateguib" target="_blank" rel="noopener noreferrer" className="relative flex min-h-11 items-center justify-center gap-2 px-3 py-2 lg:px-6 lg:py-2.5 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200">
                                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
