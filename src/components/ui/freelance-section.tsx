        ...
        <section className="relative w-full flex justify-center py-10 lg:py-16">
            <div className="container mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="w-full max-w-5xl mx-auto flex flex-col lg:flex-row-reverse items-center gap-10 lg:gap-16">
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left mt-2 px-4 lg:px-0">
                        <p className="text-xs md:text-base text-gray-300 font-mono leading-relaxed mb-6 md:mb-8">
                            {language === 'es'
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
                            <FrameButton
                                ...
                                variant="default"
                                className="w-[85%] max-w-[280px] sm:w-auto text-[10px] md:text-[11px] lg:text-xs px-4 md:px-5 py-2.5 md:py-3 gap-2"
                                size={12}
                            >
                                {copied ? <Check className="w-4 h-4 text-emerald-400" /> : <Copy className="w-3.5 h-3.5 md:w-4 md:h-4" />}
                                {copied
                            ...
                            <FrameButton
                                ...
                                variant="outline"
                                className="w-[85%] max-w-[280px] sm:w-auto text-[10px] md:text-[11px] lg:text-xs px-4 md:px-5 py-2.5 md:py-3 gap-2 text-emerald-400 border-emerald-500/40 hover:border-emerald-400 hover:bg-emerald-500/10"
                                size={12}
                            >
                                <svg width={14} height={14} viewBox="0 0 24 24" fill="currentColor" className="shrink-0 md:w-[16px] md:h-[16px]">
